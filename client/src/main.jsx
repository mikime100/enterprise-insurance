  ...
  <ConfigProvider
    theme={{
      ...
      components: {
        ...
        Menu: { darkItemBg: 'transparent', darkSubMenuItemBg: 'transparent', itemBg: 'transparent', popupBg: '#111417', darkItemSelectedBg: 'rgba(29,78,216,0.18)', darkItemSelectedColor: '#60a5fa' },
        Card: { colorBgContainer: '#ffffff', boxShadowTertiary: '0 1px 8px rgba(0,0,0,0.06)' },
        Table: { colorBgContainer: '#ffffff', headerBg: '#f9fafb', rowHoverBg: '#eff6ff', borderColor: '#e8edf3' },
        Modal: { contentBg: '#ffffff', headerBg: '#ffffff', footerBg: '#ffffff' },
        Drawer: { colorBgElevated: '#ffffff' },
        Input: { colorBgContainer: '#ffffff', activeBorderColor: '#1d4ed8' },
        ...
        Tag: { defaultBg: '#eff6ff', defaultColor: '#374151' },
        Statistic: { titleFontSize: 13 },
        Steps: { colorPrimary: '#1d4ed8' },
        Timeline: { dotBg: '#ffffff' },
        Descriptions: { labelBg: '#f9fafb' },
        Divider: { colorSplit: '#e8edf3' },
        Progress: { defaultColor: '#1d4ed8', remainingColor: '#e8edf3' },
        Tabs: { cardBg: '#f9fafb', itemSelectedColor: '#1d4ed8' },
        Badge: { colorBgContainer: '#ffffff' },
        Avatar: { colorBgBase: '#eff6ff' },
        ...
        Radio: { colorBgContainer: '#ffffff', buttonBg: '#ffffff', buttonCheckedBg: '#1d4ed8' },
